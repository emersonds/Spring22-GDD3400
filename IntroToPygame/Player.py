...
class Player:
    ...
    def update(self):
        ...
        pressed = pygame.key.get_pressed()                # Store get_pressed method to make code more readable
    ...
    def draw(self, screen):
        ...
        pygame.draw.line(screen, (255, 0, 0), (center.x, center.y), (center.x + self.velocity.x * 100, center.y + self.velocity.y * 100))   # Draw line
